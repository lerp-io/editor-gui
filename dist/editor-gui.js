...
.ed-input::-webkit-scrollbar-corner {
  background-color: #141414;
}
...
.ed-input::-webkit-scrollbar-thumb:hover {
...
.ed-menu .ed-menu-item-box.ed-selected {
  background: #ebebeb;
...
/* harmony export */ });
var BAR_DIM, DOT_DIM, MIN_HEIGHT, MIN_WIDTH, REBAR_DIM, checkFitAlignDown, checkFitAlignLeft, checkFitAlignRight, checkFitAlignUp, checkFitPositionBottom, checkFitPositionTop, checkfitPositionLeft, checkfitPositionRight, clampHeight, clampPosition, clampWidth, fixAlign, getAlignDirections, getPosition, guessAlign, initAlign;
...
Anchor = function(props) {
  ...
  checkAnchorDim = function() {
    ...
    if (content_ref.current && content_ref.current.children[0]) {
      ...
      if (props.size && (props.size[0] !== rect.width || props.size[1] !== rect.height)) {
        if (typeof props.setSize === "function") {
  ...
  if (props.size && props.visible && props.setSize) {
    ...
    resize_bar = h('div', {
      ...
      className: 'ed-anchor-handle-resize',
  ...
  return h('div', {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('ed-anchor', drag_start_pos && 'ed-anchor-drag', resize_start_pos && 'ed-anchor-resize'),
    ref: anchor_ref,
...
renderChart = function(state, props) {
  var colors, ctx, i, j, k, pan_diff, pan_x, r_height, r_left, r_top, r_width, rect, ref, results, step, x_length, x_max, x_min, x_val, y_pan, y_range, y_val;
  ...
  colors = props.colors || [];
  results = [];
  for (j = k = 0, ref = props.getY.length; (0 <= ref ? k < ref : k > ref); j = 0 <= ref ? ++k : --k) {
    i = -1;
    ctx.beginPath();
...
In = function(props) {
  var context, dispatch, input, input_ref, input_wrapper, isDragging, is_dragging, label, max, min, onMouseDown, options, outer_range_ref, props_range_value, props_value, range_rect, range_slider_x, setStepValue, slider_state_ref, state, step_value, triggerToggle, val_exists, value_alpha, value_label;
  ...
  switch (props.type) {
    ...
    case 'toggle':
      triggerToggle = function() {
        return typeof props.set === "function" ? props.set(!props.value) : void 0;
      };
      input = h('div', {
    ...
    case 'range':
      ...
      input = h('div', {
        ...
        onMouseDown: !props.disabled && onMouseDown || void 0
      }, h('div', {
    ...
    case 'button':
      ...
      input = h('button', {
        ...
        onClick: !props.disabled && (function(e) {
    ...
    case 'select':
      ...
      if (Array.isArray(props.options)) {
        val_exists = false;
        options = props.options.map(function(val) {
  ...
  if (props.type === 'toggle') {
    return h('div', {
      ...
      onClick: !props.disabled && triggerToggle || void 0
    }, h('div', {
  ...
  if (input != null) {
    input_wrapper = h('div', {
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('ed-input-wrap', props.half && 'ed-in-half' || (props.full || props.type === 'button') && 'ed-in-full')
    }, input);
  }
  return h('div', {
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('ed-in-wrap', props.half && 'ed-in-half', props.type === 'plain' && 'ed-tight', props.disabled && 'ed-in-disabled')
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _LayoutContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LayoutContext */ "./components/LayoutContext.coffee");
/* harmony import */ var _lib_waitForFontLoad_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/waitForFontLoad.js */ "./lib/waitForFontLoad.js");
var Layout, h;
...
Layout = function(props, state) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function() {
    ...
    if (props.waitForFontLoad) {
      ...
      (0,_lib_waitForFontLoad_js__WEBPACK_IMPORTED_MODULE_3__["default"])(css_font).then(function() {
        // log 'FONT LOADED'
...
Menu = function(props) {
  ...
  new_height = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.clampHeight)(context, self_height);
  ...
  if (props.align) {
    ...
    align_key = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.guessAlign)(self_width, self_height, context, self_x, self_y);
    
    // [x,y] = getPosition(self_width,self_height,context,align_key)
    align_key = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.fixAlign)(align_key, context, self_width, self_height);
  }
  ...
  if (props.position) {
    ...
    [self_x, self_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.getPosition)(self_width, self_height, context, align_key);
    [offset_x, offset_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.clampPosition)(context, self_x, self_y, self_width, self_height, align_key);
    self_x += offset_x;
    self_y += offset_y;
  }
  style = {};
  ...
  if (props.items) {
    labels = label_keys.map(function(key, i) {
      var child, label, label_style, selected, title;
      ...
      if (child.onClick || child.onSelect) {
        return h('div', {
          key: key,
          className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(props.dim && 'ed-menu-item-box', 'ed-menu-item-label', selected && 'ed-selected', 'noselect'),
          style: label_style,
      ...
      return h('button', {
        ...
        className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(props.dim && 'ed-menu-item-box', 'ed-menu-item-label', props.select === key && 'ed-selected', 'noselect')
      }, label);
    });
  }
  return h('div', {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Anchor: () => (/* reexport safe */ _Anchor__WEBPACK_IMPORTED_MODULE_8__["default"]),
/* harmony export */   Box: () => (/* reexport safe */ _Box__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   BoxContext: () => (/* reexport safe */ _BoxContext__WEBPACK_IMPORTED_MODULE_7__["default"]),
/* harmony export */   In: () => (/* reexport safe */ _In__WEBPACK_IMPORTED_MODULE_3__["default"]),
/* harmony export */   Layout: () => (/* reexport safe */ _Layout__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   LayoutContext: () => (/* reexport safe */ _LayoutContext__WEBPACK_IMPORTED_MODULE_6__["default"]),
/* harmony export */   Menu: () => (/* reexport safe */ _Menu__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   Section: () => (/* reexport safe */ _Section__WEBPACK_IMPORTED_MODULE_4__["default"]),
/* harmony export */   Separator: () => (/* reexport safe */ _Separator__WEBPACK_IMPORTED_MODULE_5__["default"])
/* harmony export */ });
/* harmony import */ var _Layout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Layout */ "./components/Layout.coffee");
/* harmony import */ var _Menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Menu */ "./components/Menu.coffee");
/* harmony import */ var _Box__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Box */ "./components/Box.coffee");
/* harmony import */ var _In__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./In */ "./components/In.coffee");
/* harmony import */ var _Section__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Section */ "./components/Section.coffee");
/* harmony import */ var _Separator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Separator */ "./components/Separator.coffee");
/* harmony import */ var _LayoutContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./LayoutContext */ "./components/LayoutContext.coffee");
/* harmony import */ var _BoxContext__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./BoxContext */ "./components/BoxContext.coffee");
/* harmony import */ var _Anchor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Anchor */ "./components/Anchor.coffee");
/* harmony import */ var _Style_less__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Style.less */ "./components/Style.less");
