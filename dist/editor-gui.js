...
/* harmony export */   "default": () => (/* binding */ waitForFontLoad)
/* harmony export */ });
async function waitForFontLoad(font,timeout,interval){
...
/* harmony export */   "fixAlign": () => (/* binding */ fixAlign),
/* harmony export */   "guessAlign": () => (/* binding */ guessAlign),
/* harmony export */   "clampHeight": () => (/* binding */ clampHeight),
/* harmony export */   "clampWidth": () => (/* binding */ clampWidth)
/* harmony export */ });
...
Anchor = function(props) {
  ...
  anchor_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)('ed-anchor', anchor_ref);
  context = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_LayoutContext__WEBPACK_IMPORTED_MODULE_2__.default);
  content_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  [dim, setDim] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({});
  [drag_start_pos, setDragStartPos] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(void 0);
  [resize_start_pos, setResizeStartPos] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(void 0);
  [resize_dir, setResizeDir] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(void 0);
  [set_handle_pos, setHandlePos] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(void 0);
  [is_dragging, setDragging] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  [z_index, setZIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  ...
  if (dim.width && dim.height) {
    ...
    [offset_x, offset_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_3__.clampPosition)(context, props.position[0], props.position[1], self_width, self_height, void 0);
...
Box = function(props, state) {
  ...
  self_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  content_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function() {
    ...
    if (content_ref.current) {
      ...
      set_height = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.clampHeight)(context, content_height);
      set_width = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.clampWidth)(context, content_width);
  ...
  if (props.align) {
    ...
    align_key = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.guessAlign)(width, height, context);
    [x, y] = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.getPosition)(width, height, context, align_key);
    align_key = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.fixAlign)(align_key, context, width, height);
  }
  if (props.position) {
    ...
    [self_x, self_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.getPosition)(width, height, context, align_key);
    [offset_x, offset_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_4__.clampPosition)(context, self_x, self_y, width, height, align_key);
    self_x += offset_x;
    self_y += offset_y;
  }
...
LineChart = function(props) {
  ...
  wrap_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  canvas_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  canvas_state = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)({
    pan_x: 0
  });
  context = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_BoxContext__WEBPACK_IMPORTED_MODULE_2__.default);
  [rect, setRect] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  [tick_step, setTickStep] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function() {
    if (wrap_ref.current) {
...
In = function(props) {
  ...
  [state, dispatch] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(reducer, initial_state);
  [is_dragging, isDragging] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  [step_value, setStepValue] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(void 0);
  context = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_BoxContext__WEBPACK_IMPORTED_MODULE_2__.default);
  outer_range_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  slider_state_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)({});
  input_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  if (props.label) {
    label = h('div', {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (In);
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _LayoutContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LayoutContext */ "./components/LayoutContext.coffee");
/* harmony import */ var _waitForFontLoad_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./waitForFontLoad.js */ "./components/waitForFontLoad.js");
var Layout, h;
...
Layout = function(props, state) {
  ...
  measure_text = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(new Map());
  canvas_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  [is_dragging, isDragging] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function() {
    ...
    if (props.waitForFontLoad) {
      ...
      (0,_waitForFontLoad_js__WEBPACK_IMPORTED_MODULE_3__.default)(css_font).then(function() {
        // log 'FONT LOADED'
...
Menu = function(props) {
  ...
  menu_ref = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function() {
    return function() {
      // log 'DECELECT'
  ...
  new_height = (0,_Align__WEBPACK_IMPORTED_MODULE_3__.clampHeight)(context, self_height);
  ...
  if (props.align) {
    ...
    align_key = (0,_Align__WEBPACK_IMPORTED_MODULE_3__.guessAlign)(self_width, self_height, context, self_x, self_y);
    // log 'GUESSED ALIGN FOR ',context.selected_label,' : ',align_key
    // [x,y] = getPosition(self_width,self_height,context,align_key)
    align_key = (0,_Align__WEBPACK_IMPORTED_MODULE_3__.fixAlign)(align_key, context, self_width, self_height);
  }
  ...
  if (props.position) {
    ...
    [self_x, self_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_3__.getPosition)(self_width, self_height, context, align_key);
    [offset_x, offset_y] = (0,_Align__WEBPACK_IMPORTED_MODULE_3__.clampPosition)(context, self_x, self_y, self_width, self_height, align_key);
    self_x += offset_x;
    self_y += offset_y;
  }
  style = {};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Box": () => (/* reexport safe */ _Box__WEBPACK_IMPORTED_MODULE_3__.default),
/* harmony export */   "In": () => (/* reexport safe */ _In__WEBPACK_IMPORTED_MODULE_4__.default),
...
/* harmony export */   "Section": () => (/* reexport safe */ _Section__WEBPACK_IMPORTED_MODULE_5__.default),
/* harmony export */   "Separator": () => (/* reexport safe */ _Separator__WEBPACK_IMPORTED_MODULE_6__.default),
/* harmony export */   "Anchor": () => (/* reexport safe */ _Anchor__WEBPACK_IMPORTED_MODULE_7__.default)
/* harmony export */ });
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".noselect {\n  -webkit-touch-callout: none;\n  /* iOS Safari */\n  -webkit-user-select: none;\n  /* Safari */\n  -khtml-user-select: none;\n  /* Konqueror HTML */\n  -moz-user-select: none;\n  /* Old versions of Firefox */\n  -ms-user-select: none;\n  /* Internet Explorer/Edge */\n  user-select: none;\n  /* Non-prefixed version, currently\n                                  supported by Chrome, Edge, Opera and Firefox */\n}\n.ed-layout {\n  z-index: 100;\n  text-rendering: optimizeSpeed;\n  line-height: 95%;\n  font-family: 'DM Mono', monospace;\n  font-size: 0.85em;\n  color: #ffffff;\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  pointer-events: none;\n}\n.ed-layout * {\n  pointer-events: all;\n  box-sizing: border-box;\n}\n.ed-layout-dragging {\n  pointer-events: all;\n  cursor: ew-resize;\n}\n.ed-layout-dragging * {\n  pointer-events: none !important;\n}\n.ed-full-w {\n  width: 100%;\n}\n.ed-flex-left,\n.ed-input-wrap {\n  display: flex;\n  flex-wrap: wrap;\n  position: relative;\n  flex-direction: row-reverse;\n  align-items: center;\n  justify-content: flex-end;\n}\n.ed-flex-right,\n.ed-in-wrap {\n  display: flex;\n  position: relative;\n  flex-direction: row;\n  align-items: center;\n  justify-content: flex-start;\n}\n.ed-flex-down {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  justify-content: flex-start;\n}\n.ed-in-wrap {\n  font-size: 0.9em;\n  width: 100%;\n  padding: 0px 0.425em;\n  min-height: 1.6em;\n  flex-wrap: nowrap;\n  margin-bottom: 0.255em;\n}\n.ed-in-wrap.ed-in-half {\n  width: 50%;\n}\n.ed-in-wrap.ed-tight {\n  min-height: 1em;\n}\n.ed-in-wrap:last-child {\n  margin-bottom: 0px;\n}\n.ed-in-wrap-toggle-input {\n  width: auto;\n  flex-shrink: 0;\n}\n.ed-in-wrap-toggle-label {\n  width: auto;\n}\n.ed-input-wrap {\n  width: 150%;\n}\n.ed-input-wrap.ed-in-half {\n  width: fit-content;\n}\n.ed-in-label {\n  width: 100%;\n  margin-left: 0.4em;\n  color: #c8c8c8;\n  white-space: normal;\n  text-align: -webkit-left;\n  align-items: flex-start;\n  justify-content: flex-start;\n  word-break: break-all;\n}\n.ed-in-label-colon {\n  color: #c8c8c8;\n}\ninput:disabled {\n  color: #c8c8c8 !important;\n  -webkit-user-select: none !important;\n  user-select: none !important;\n  cursor: default !important;\n}\n.ed-input {\n  width: inherit;\n  line-height: 1.6em;\n  height: 1.6em;\n  font-size: inherit;\n  font-family: 'DM Mono', monospace;\n  -webkit-appearance: none;\n  outline: none;\n  color: #ffffff;\n  background-color: #141414;\n  border: none;\n  border-radius: none;\n  padding: 0px 0.425em;\n}\n.ed-input-plain {\n  background-color: #1e1e1e;\n}\n.ed-toggle-outer {\n  width: 1.6em;\n  cursor: pointer;\n  height: 1.6em;\n  background-color: #141414;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.ed-toggle-outer .ed-toggle-inner {\n  width: 0.8em;\n  height: 0.8em;\n  border-radius: 0.8em;\n  background-color: #2a2a2a;\n}\n.ed-toggle-outer .ed-toggle-inner.ed-toggle-active {\n  background: #ffffff;\n}\n.ed-box-title {\n  padding: 0.425em;\n  padding-bottom: 0.425em/2;\n  font-weight: 800;\n  text-align: center;\n  display: flex;\n  color: white;\n  align-items: flex-start;\n  justify-content: flex-start;\n  flex-direction: row;\n  width: 100%;\n  z-index: 1;\n  background: #2a2a2a;\n  text-transform: uppercase !important;\n}\n.ed-box-title * {\n  white-space: pre;\n}\n.ed-box-title .ed-in-label-colon {\n  color: #c8c8c8;\n}\n.ed-box-title-sticky {\n  position: sticky;\n  top: 0px;\n  background: #ffffff;\n  color: #2a2a2a;\n  margin-bottom: 0.425em;\n}\n.ed-box-content {\n  display: flex;\n  align-self: start;\n  justify-content: start;\n  flex-direction: row;\n  flex-wrap: wrap;\n  padding-bottom: 0.85em;\n}\n.ed-box::-webkit-scrollbar,\n.ed-menu::-webkit-scrollbar {\n  -webkit-appearance: none;\n  background-color: #141414;\n  width: 4px;\n  height: 4px;\n  border-radius: 0px;\n}\n.ed-box::-webkit-scrollbar-corner,\n.ed-menu::-webkit-scrollbar-corner {\n  background-color: #141414;\n}\n.ed-box::-webkit-scrollbar-thumb,\n.ed-menu::-webkit-scrollbar-thumb {\n  border-radius: 0px;\n  background-color: #7F7F7F;\n}\n.ed-box::-webkit-scrollbar-thumb:hover,\n.ed-menu::-webkit-scrollbar-thumb:hover {\n  background-color: #8F8F8F;\n}\n.ed-box {\n  background-color: #2a2a2a;\n  color: #ffffff;\n  position: fixed;\n  width: 300px;\n  flex-wrap: nowrap;\n}\n.ed-box.ed-scroll {\n  overflow-y: scroll;\n  overflow-x: hidden;\n  width: 324px;\n}\n.ed-box .ed-description {\n  padding: 0px 0.425em;\n  font-size: 0.8em;\n  color: #ebebeb;\n  margin: 0.425em 0px;\n  margin-top: 0px;\n  white-space: normal;\n}\n.ed-menu-child-wrapper {\n  position: relative;\n  left: -100%;\n  top: 12px;\n}\n.ed-menu {\n  color: #ffffff;\n  flex-wrap: nowrap;\n  width: fit-content;\n  height: fit-content;\n  position: fixed;\n}\n.ed-menu.ed-scroll {\n  overflow-y: scroll;\n  overflow-x: hidden;\n}\n.ed-menu.ed-flex-down > .ed-menu-item {\n  width: -webkit-fill-available;\n  height: auto;\n}\n.ed-menu.ed-flex-right > .ed-menu-item {\n  height: -webkit-fill-available;\n  width: auto;\n}\n.ed-menu .ed-menu-labels {\n  background-color: #2a2a2a;\n}\n.ed-menu .ed-menu-item-label {\n  white-space: pre;\n  width: -webkit-fill-available;\n  height: 1.6em;\n  text-transform: uppercase;\n  display: flex;\n  align-items: center;\n  color: #ebebeb;\n  background: none;\n  border: none;\n  outline: none;\n  font: inherit;\n  padding: 0px;\n  cursor: pointer;\n}\n.ed-menu .ed-menu-item-label.ed-selected {\n  background-color: #141414;\n  color: #ffffff;\n}\n.ed-menu .ed-menu-item-label:hover {\n  color: #ffffff;\n  background: #1e1e1e;\n}\n.ed-menu .ed-menu-item {\n  position: relative;\n}\n.ed-menu.ed-menu-alt > .ed-menu-labels > .ed-menu-item-label {\n  background-color: #141414;\n}\n.ed-menu.ed-menu-alt > .ed-menu-labels > .ed-menu-item-label.ed-selected {\n  background-color: #2a2a2a;\n}\n.ed-hidden {\n  visibility: hidden;\n}\n.ed-range-outer {\n  height: 1.6em;\n  width: 100%;\n  background: #141414;\n  position: relative;\n  cursor: ew-resize;\n}\n.ed-range-outer .ed-range-slider {\n  width: 6.5px;\n  height: 1.6em;\n  background: #ffffff;\n}\n.ed-range-outer .ed-range-slider.ed-active {\n  background: #ffffff;\n}\n.ed-range-outer .ed-range-value {\n  position: absolute;\n  left: 14px;\n  top: 50%;\n  transform: translate(0%, -50%);\n}\n.ed-range-outer .ed-range-value.ed-range-value-snap {\n  right: 8px;\n  left: initial;\n}\n.ed-range-outer .ed-range-value.ed-range-value-left {\n  right: 14px;\n  left: initial;\n}\n.ed-range-outer .ed-range-value.ed-range-value-left.ed-range-value-snap {\n  left: 8px;\n  right: initial;\n}\n.ed-button {\n  outline: none;\n  -webkit-appearance: none;\n  font: inherit;\n  border: none;\n  cursor: pointer;\n  width: 100%;\n  height: 1.6em;\n  background: #141414;\n  color: #ebebeb;\n}\n.ed-button:hover {\n  color: #ffffff;\n}\n.ed-color-box {\n  position: relative;\n  -webkit-appearance: none;\n  width: 3.2em;\n  height: 1.6em;\n  flex-shrink: 0;\n  cursor: pointer;\n  margin-right: 0.255em;\n  border: 3px solid black;\n}\n.ed-color-box .ed-color-box-input {\n  visibility: visible;\n  opacity: 0;\n  cursor: pointer;\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  padding: 0px;\n  left: 0px;\n  top: 0px;\n}\n.ed-value-box {\n  width: 100%;\n  height: 1.6em;\n  background-color: #2a2a2a;\n  margin-left: 0.153em;\n  line-height: 1.6em;\n  padding: 0px 0.425em;\n}\n.ed-section {\n  margin: 0.425em 0px;\n  padding: 0.425em 0px;\n  position: relative;\n  border-top: 1px solid rgba(150, 150, 150, 0.3);\n  border-bottom: 1px solid rgba(150, 150, 150, 0.3);\n}\n.ed-section-title {\n  min-height: 1.6em;\n  cursor: pointer;\n  white-space: pre;\n  font-weight: 800;\n  width: 100%;\n  padding: 0px 0.425em;\n  text-transform: uppercase;\n}\n.ed-section-label-toggle-off {\n  cursor: default;\n}\n.ed-section-label-toggle {\n  font-size: 0.85em;\n  width: 100%;\n  padding-right: 0.425em;\n  display: flex;\n  color: #c8c8c8;\n  flex-direction: column;\n  align-items: flex-end;\n  justify-content: flex-end;\n}\n.ed-section-label-toggle.ed-section-label-toggle-active {\n  color: #ebebeb;\n}\n.ed-section-end-label {\n  padding: 0.425em;\n  display: flex;\n  width: 100%;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n}\n.ed-input-select {\n  width: 100%;\n  outline: none;\n  -webkit-appearance: none;\n  height: 24px;\n  cursor: pointer;\n  padding: 0px 0.425em;\n  border: none;\n  color: #ffffff;\n  background: #141414;\n}\n.ed-input-select-arrow {\n  position: absolute;\n  right: 14px;\n  color: #c8c8c8;\n  font-family: monospace;\n}\n.ed-separator {\n  margin-top: 1.6em / 3;\n  border-bottom: 1px solid rgba(150, 150, 150, 0.3);\n  height: 0px;\n  width: 100%;\n  margin-bottom: 1.6em / 2;\n}\n.ed-line-chart {\n  width: 100%;\n  height: 80px;\n  background: #141414;\n}\n.ed-line-chart-wrap {\n  flex-direction: column;\n  align-content: flex-start;\n  justify-content: flex-start;\n  align-items: flex-start;\n}\n.ed-line-chart-wrap canvas {\n  cursor: ew-resize;\n  width: 100%;\n  height: 100%;\n}\n.ed-line-chart-label {\n  padding: 0.425em 0px;\n}\n.ed-anchor {\n  display: flex;\n  flex-direction: row;\n  position: fixed;\n}\n.ed-anchor .ed-anchor-handle {\n  position: fixed;\n  background: black;\n  cursor: move;\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  align-items: center;\n}\n.ed-anchor .ed-anchor-handle .ed-anchor-dot {\n  margin: 0.26666667em;\n  pointer-events: none;\n  background: white;\n  width: 0.26666667em;\n  height: 0.26666667em;\n}\n.ed-anchor .ed-anchor-handle-resize {\n  width: 0.8em;\n  height: 0.8em;\n  background: black;\n  position: absolute;\n  top: 0;\n  left: 0;\n  z-index: 1;\n}\n.ed-anchor.ed-anchor-drag {\n  pointer-events: all;\n  cursor: move;\n}\n.ed-anchor.ed-anchor-drag * {\n  pointer-events: none !important;\n}\n.ed-anchor.ed-anchor-resize {\n  pointer-events: all;\n}\n.ed-anchor.ed-anchor-resize * {\n  pointer-events: none !important;\n}\n", "",{"version":3,"sources":["webpack://./components/Style.less"],"names":[],"mappings":"AAgBA;EACE,2BAAA;EAfA,eAAe;EAgBb,yBAAA;EAdF,WAAW;EAeR,wBAAA;EAbH,mBAAmB;EAcd,sBAAA;EAZL,4BAA4B;EAatB,qBAAA;EAXN,2BAA2B;EAYjB,iBAAA;EAVV;gFAC8E;AAChF;AAYA;EACC,YAAA;EAEA,6BAAA;EACA,gBAAA;EACA,iCAAA;EACA,iBAAA;EACA,cAAA;EACA,eAAA;EACA,QAAA;EACA,SAAA;EACA,WAAA;EACA,YAAA;EACA,gBAAA;EACA,oBAAA;AAXD;AAHA;EAgBE,mBAAA;EACA,sBAAA;AAVF;AAcA;EACC,mBAAA;EACA,iBAAA;AAZD;AAUA;EAIE,+BAAA;AAXF;AAeA;EACC,WAAA;AAbD;AAgBA;;EACC,aAAA;EACA,eAAA;EACA,kBAAA;EACA,2BAAA;EACA,mBAAA;EACA,yBAAA;AAbD;AAgBA;;EACC,aAAA;EACA,kBAAA;EAEA,mBAAA;EACA,mBAAA;EACA,2BAAA;AAdD;AAiBA;EACC,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,2BAAA;AAfD;AAkBA;EACC,gBAAA;EACA,WAAA;EACA,oBAAA;EACA,iBAAA;EAEA,iBAAA;EAEA,sBAAA;AAlBD;AAmBC;EACC,UAAA;AAjBF;AAmBC;EACC,eAAA;AAjBF;AAmBC;EACC,kBAAA;AAjBF;AAqBA;EACC,WAAA;EACA,cAAA;AAnBD;AAuBA;EACC,WAAA;AArBD;AAwBA;EAGC,WAAA;AAxBD;AAyBC;EACC,kBAAA;AAvBF;AA2BA;EACC,WAAA;EACA,kBAAA;EACA,cAAA;EACA,mBAAA;EACA,wBAAA;EACA,uBAAA;EACA,2BAAA;EACA,qBAAA;AAzBD;AA4BA;EACC,cAAA;AA1BD;AA6BA;EACC,yBAAA;EACA,oCAAA;EACA,4BAAA;EACA,0BAAA;AA3BD;AA8BA;EACC,cAAA;EACA,kBAAA;EACA,aAAA;EACA,kBAAA;EACA,iCAAA;EACA,wBAAA;EACA,aAAA;EACA,cAAA;EACA,yBAAA;EACA,YAAA;EACA,mBAAA;EACA,oBAAA;AA5BD;AAgCA;EACC,yBAAA;AA9BD;AAiCA;EACC,YAAA;EACA,eAAA;EACA,aAAA;EACA,yBAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;AA/BD;AAwBA;EASE,YAAA;EACA,aAAA;EACA,oBAAA;EACA,yBAAA;AA9BF;AA+BE;EACC,mBAAA;AA7BH;AAkCA;EAEC,gBAAA;EACA,yBAAA;EAEA,gBAAA;EACA,kBAAA;EACA,aAAA;EACA,YAAA;EAIA,uBAAA;EACA,2BAAA;EACA,mBAAA;EACA,WAAA;EAEA,UAAA;EACA,mBAAA;EAIA,oCAAA;AAzCD;AAmBA;EAUE,gBAAA;AA1BF;AAgBA;EAoBE,cAAA;AAjCF;AAsCA;EACC,gBAAA;EACA,QAAA;EACA,mBAAA;EACA,cAAA;EACA,sBAAA;AApCD;AAuCA;EAEC,aAAA;EACA,iBAAA;EACA,sBAAA;EACA,mBAAA;EACA,eAAA;EACA,sBAAA;AAtCD;AA2CC;;EACC,wBAAA;EACA,yBAAA;EACA,UAAA;EACA,WAAA;EACA,kBAAA;AAxCF;AA0CC;;EACC,yBAAA;AAvCF;AAyCC;;EACC,kBAAA;EACA,yBAAA;AAtCF;AAuCE;;EACC,yBAAA;AApCH;AAyCA;EAWC,yBAAA;EACA,cAAA;EACA,eAAA;EACA,YAAA;EAKA,iBAAA;AArDD;AAsCC;EACC,kBAAA;EACA,kBAAA;EACA,YAAA;AApCF;AA6BA;EAqBE,oBAAA;EAEA,gBAAA;EACA,cAAA;EACA,mBAAA;EACA,eAAA;EACA,mBAAA;AAhDF;AAwDA;EACC,kBAAA;EACA,WAAA;EACA,SAAA;AAtDD;AAyDA;EAEC,cAAA;EACA,iBAAA;EACA,kBAAA;EACA,mBAAA;EACA,eAAA;AAxDD;AA0DC;EACC,kBAAA;EACA,kBAAA;AAxDF;AA0DC;EAEE,6BAAA;EACA,YAAA;AAzDH;AA4DC;EAEE,8BAAA;EACA,WAAA;AA3DH;AAsCA;EAyBE,yBAAA;AA5DF;AAmCA;EA6BE,gBAAA;EAGA,6BAAA;EACA,aAAA;EACA,yBAAA;EACA,aAAA;EACA,mBAAA;EACA,cAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;EACA,aAAA;EACA,YAAA;EAOA,eAAA;AArEF;AAgEE;EACC,yBAAA;EAEA,cAAA;AA/DH;AAmEE;EACC,cAAA;EACA,mBAAA;AAjEH;AAYA;EA0DE,kBAAA;AAnEF;AAsEC;EAGE,yBAAA;AAtEH;AAmEC;EAME,yBAAA;AAtEH;AAiFA;EACC,kBAAA;AA/ED;AAkFA;EACC,aAAA;EACG,WAAA;EACH,mBAAA;EACA,kBAAA;EA6BA,iBAAA;AA5GD;AA2EA;EAME,YAAA;EACA,aAAA;EACA,mBAAA;AA9EF;AA+EE;EACC,mBAAA;AA7EH;AAmEA;EAeE,kBAAA;EACA,UAAA;EACA,QAAA;EACA,8BAAA;AA/EF;AAgFE;EACC,UAAA;EACA,aAAA;AA9EH;AAgFE;EACC,WAAA;EACA,aAAA;AA9EH;AA+EG;EACC,SAAA;EACA,cAAA;AA7EJ;AAqFA;EACC,aAAA;EACA,wBAAA;EACA,aAAA;EACA,YAAA;EACA,eAAA;EACA,WAAA;EACA,aAAA;EACA,mBAAA;EACA,cAAA;AAnFD;AAoFC;EACC,cAAA;AAlFF;AAsFA;EACC,kBAAA;EACA,wBAAA;EACA,YAAA;EACA,aAAA;EACA,cAAA;EACA,eAAA;EACA,qBAAA;EACA,uBAAA;AApFD;AA4EA;EAUE,mBAAA;EACA,UAAA;EACA,eAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,YAAA;EACA,SAAA;EACA,QAAA;AAnFF;AAuFA;EACC,WAAA;EAEA,aAAA;EACA,yBAAA;EACA,oBAAA;EACA,kBAAA;EACA,oBAAA;AAtFD;AA2FA;EAEC,mBAAA;EACA,oBAAA;EACA,kBAAA;EAIA,8CAAA;EACA,iDAAA;AA7FD;AAiGA;EACC,iBAAA;EACA,eAAA;EACA,gBAAA;EAEA,gBAAA;EACA,WAAA;EACA,oBAAA;EACA,yBAAA;AAhGD;AAkGA;EACC,eAAA;AAhGD;AAkGA;EACC,iBAAA;EACA,WAAA;EACA,sBAAA;EACA,aAAA;EACA,cAAA;EACA,sBAAA;EACA,qBAAA;EACA,yBAAA;AAhGD;AAiGC;EACC,cAAA;AA/FF;AAkGA;EACC,gBAAA;EACA,aAAA;EACA,WAAA;EACA,mBAAA;EACA,mBAAA;EACA,uBAAA;AAhGD;AAoGA;EACC,WAAA;EACA,aAAA;EACA,wBAAA;EACA,YAAA;EACA,eAAA;EACA,oBAAA;EACA,YAAA;EACA,cAAA;EACA,mBAAA;AAlGD;AAoGA;EACC,kBAAA;EACA,WAAA;EACA,cAAA;EACA,sBAAA;AAlGD;AAsGA;EACC,qBAAA;EACA,iDAAA;EACA,WAAA;EACA,WAAA;EACA,wBAAA;AApGD;AAuGA;EACC,WAAA;EACA,YAAA;EACA,mBAAA;AArGD;AAwGA;EACC,sBAAA;EACA,yBAAA;EACA,2BAAA;EACA,uBAAA;AAtGD;AAkGA;EAME,iBAAA;EACA,WAAA;EACA,YAAA;AArGF;AAwGA;EAEC,oBAAA;AAvGD;AA0GA;EACC,aAAA;EACA,mBAAA;EACA,eAAA;AAxGD;AAqGA;EAKE,eAAA;EACA,iBAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;EACA,qBAAA;EACA,mBAAA;AAvGF;AA4FA;EAaG,oBAAA;EACA,oBAAA;EACA,iBAAA;EACA,mBAAA;EACA,oBAAA;AAtGH;AAqFA;EA0BE,YAAA;EACA,aAAA;EACA,iBAAA;EACA,kBAAA;EAEA,MAAA;EACA,OAAA;EACA,UAAA;AA7GF;AAgHC;EACC,mBAAA;EACA,YAAA;AA9GF;AA4GC;EAIE,+BAAA;AA7GH;AAgHC;EACC,mBAAA;AA9GF;AA6GC;EAIE,+BAAA;AA9GH","sourcesContent":["@bg1:rgba(42,42,42, 1.0);\n@bg2:rgba(20,20,20, 1.0);\n@bg3:rgba(30,30,30, 1.0);\n\n@color1: rgb(255, 255, 255);\n@color2: rgb(235, 235, 235);\n@color3: rgb(200, 200, 200);\n@color4: rgba(150, 150, 150,0.3);\n\n@mainfont: 'DM Mono', monospace;\n@fontsize: .85em;\n@padding: @fontsize*.5;\n@padding2: @fontsize;\n@margin: @padding*.6;\n@dim: 1.60em;\n\n.noselect {\n  -webkit-touch-callout: none; /* iOS Safari */\n    -webkit-user-select: none; /* Safari */\n     -khtml-user-select: none; /* Konqueror HTML */\n       -moz-user-select: none; /* Old versions of Firefox */\n        -ms-user-select: none; /* Internet Explorer/Edge */\n            user-select: none; /* Non-prefixed version, currently\n                                  supported by Chrome, Edge, Opera and Firefox */\n}\n\n.ed-layout{\n\tz-index: 100;\n\t// transform: translate3D(0.0px,0.0px,0.0px);\n\ttext-rendering: optimizeSpeed;\n\tline-height: 95%;\n\tfont-family: @mainfont;\n\tfont-size: @fontsize;\n\tcolor: @color1;\n\tposition: fixed;\n\ttop: 0px;\n\tleft: 0px;\n\twidth: 100%;\n\theight: 100%;\n\toverflow: hidden;\n\tpointer-events: none;\n\t*{\n\t\tpointer-events: all;\n\t\tbox-sizing: border-box;\n\t}\n}\n\n.ed-layout-dragging{\n\tpointer-events: all;\n\tcursor: ew-resize;\n\t*{\n\t\tpointer-events: none !important;\n\t}\n}\n\n.ed-full-w{\n\twidth: 100%;\n}\n\n.ed-flex-left{\n\tdisplay: flex;\n\tflex-wrap: wrap;\n\tposition: relative;\n\tflex-direction: row-reverse;\n\talign-items: center;\n\tjustify-content: flex-end;\n}\n\n.ed-flex-right{\n\tdisplay: flex;\n\tposition: relative;\n\t// flex-wrap: wrap;\n\tflex-direction: row;\n\talign-items: center;\n\tjustify-content: flex-start;\n}\n\n.ed-flex-down{\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: flex-start;\n\tjustify-content: flex-start;\n}\n\n.ed-in-wrap{\n\tfont-size: .9em;\n\twidth: 100%;\n\tpadding: 0px @padding;\n\tmin-height: @dim;\n\t&:extend(.ed-flex-right);\n\tflex-wrap: nowrap;\n\t// margin-top: @padding;\n\tmargin-bottom: @margin;\n\t&.ed-in-half{\n\t\twidth: 50%;\n\t}\n\t&.ed-tight{\n\t\tmin-height: 1em;\n\t}\n\t&:last-child{\n\t\tmargin-bottom: 0px;\n\t}\n}\n\n.ed-in-wrap-toggle-input{\n\twidth: auto;\n\tflex-shrink: 0;\n\t// margin-right: 4px;\n}\n\n.ed-in-wrap-toggle-label{\n\twidth: auto;\n}\n\n.ed-input-wrap{\n\t\n\t&:extend(.ed-flex-left);\n\twidth: 150%;\n\t&.ed-in-half{\n\t\twidth: fit-content;\n\t}\n}\n\n.ed-in-label{\n\twidth: 100%;\n\tmargin-left: 0.4em;\n\tcolor: @color3;\n\twhite-space: normal;\n\ttext-align: -webkit-left;\n\talign-items: flex-start;\n\tjustify-content: flex-start;\n\tword-break: break-all;\n}\n\n.ed-in-label-colon{\n\tcolor: @color3;\n}\n\ninput:disabled{\n\tcolor: @color3 !important;\n\t-webkit-user-select: none !important;\n\tuser-select: none !important;\n\tcursor: default !important;\n}\n\n.ed-input{\n\twidth: inherit;\n\tline-height: @dim;\n\theight: @dim;\n\tfont-size: inherit;\n\tfont-family: @mainfont;\n\t-webkit-appearance: none;\n\toutline: none;\n\tcolor: @color1;\n\tbackground-color: @bg2;\n\tborder: none;\n\tborder-radius: none;\n\tpadding: 0px @padding;\n\t// margin-left: @padding2;\n\t\n}\n.ed-input-plain{\n\tbackground-color: @bg3;\n}\n\n.ed-toggle-outer{\n\twidth: @dim;\n\tcursor: pointer;\n\theight: @dim;\n\tbackground-color: @bg2;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\t.ed-toggle-inner{\n\t\twidth: (@dim/2);\n\t\theight: (@dim/2);\n\t\tborder-radius: (@dim/2);\n\t\tbackground-color: @bg1;\n\t\t&.ed-toggle-active{\n\t\t\tbackground: @color1;\n\t\t}\n\t}\n}\n\n.ed-box-title{\n\t\n\tpadding: @padding;\n\tpadding-bottom: @padding/2;\n\t// margin-bottom: @padding;\n\tfont-weight: 800;\n\ttext-align: center;\n\tdisplay: flex;\n\tcolor: white;\n\t*{\n\t\twhite-space: pre;\n\t}\n\talign-items:flex-start;\n\tjustify-content: flex-start;\n\tflex-direction: row;\n\twidth: 100%;\n\t\n\tz-index: 1;\n\tbackground: @bg1;\n\t.ed-in-label-colon{\n\t\tcolor: @color3;\n\t}\n\ttext-transform: uppercase !important;\n}\n\n.ed-box-title-sticky{\n\tposition: sticky;\n\ttop:0px;\n\tbackground: @color1;\n\tcolor: @bg1;\n\tmargin-bottom: @padding;\n}\n\n.ed-box-content{\n\t// padding: 0px @padding;\n\tdisplay: flex;\n\talign-self: start;\n\tjustify-content: start;\n\tflex-direction: row;\n\tflex-wrap: wrap;\n\tpadding-bottom: @padding2;\n}\n\n\n.ed-box,.ed-menu{\n\t&::-webkit-scrollbar{\n\t\t-webkit-appearance: none;\n\t\tbackground-color: @bg2;\n\t\twidth: 4px;\n\t\theight: 4px;\n\t\tborder-radius: 0px;\n\t}\n\t&::-webkit-scrollbar-corner {\n\t\tbackground-color: @bg2;\n\t}\n\t&::-webkit-scrollbar-thumb{\n\t\tborder-radius: 0px;\n\t\tbackground-color: #7F7F7F;\n\t\t&:hover{\n\t\t\tbackground-color: #8F8F8F;\n\t\t}\n\t}\n}\n\n.ed-box{\n\t\n\n\t\n\t&.ed-scroll{\n\t\toverflow-y: scroll;\n\t\toverflow-x: hidden;\n\t\twidth: 324px;\n\t}\n\t// box-shadow: inset 0px 0px 4px #00000052;\n\t// backdrop-filter: @blur;\n\tbackground-color: @bg1;\n\tcolor: @color1;\n\tposition: fixed;\n\twidth: 300px;\n\t\n\t// box-shadow: inset 0px 0px 2px #757575;\n\t// border: 1px solid black;\n\t// padding: @padding @padding2;\n\tflex-wrap: nowrap;\n\t.ed-description{\n\t\tpadding: 0px @padding;\n\t\t// padding-top: 0;\n\t\tfont-size: 0.8em;\n\t\tcolor: @color2;\n\t\tmargin: @padding 0px;\n\t\tmargin-top: 0px;\n\t\twhite-space: normal;\n\t\t// border-bottom: 3px solid @color2;\n\t}\n}\n\n// .ed-menu.ed-flex-right>.ed-menu.ed-flex-down{\n// \tmin-width: -webkit-fill-available;\n// }\n.ed-menu-child-wrapper{\n\tposition: relative;\n\tleft: -100%;\n\ttop: 12px;\n}\n\n.ed-menu{\n\t// box-shadow:  0px 0px 3px black;\n\tcolor: @color1;\n\tflex-wrap: nowrap;\n\twidth: fit-content;\n\theight: fit-content;\n\tposition: fixed;\n\t\n\t&.ed-scroll{\n\t\toverflow-y: scroll;\n\t\toverflow-x: hidden;\n\t}\n\t&.ed-flex-down{\n\t\t>.ed-menu-item{\n\t\t\twidth: -webkit-fill-available;\n\t\t\theight: auto;\n\t\t}\n\t}\n\t&.ed-flex-right{\n\t\t>.ed-menu-item{\n\t\t\theight: -webkit-fill-available;\n\t\t\twidth: auto\n\t\t}\n\t}\n\t.ed-menu-labels{\n\t\tbackground-color: @bg1;\n\t\t// backdrop-filter: @blur;\n\t}\n\t.ed-menu-item-label{\n\t\twhite-space: pre;\n\t\t// background-color: @bg1;\n\t\tcolor: @color2;\n\t\twidth: -webkit-fill-available;\n\t\theight: @dim;\n\t\ttext-transform: uppercase;\n\t\tdisplay: flex;\n\t\talign-items: center;\n\t\tcolor: @color2;\n\t\tbackground: none;\n\t\tborder: none;\n\t\toutline: none;\n\t\tfont: inherit;\n\t\tpadding: 0px;\n\t\t\n\t\t&.ed-selected{\n\t\t\tbackground-color: @bg2;\n\t\t\t// backdrop-filter: @blur;\n\t\t\tcolor: @color1;\n\t\t}\n\t\tcursor: pointer;\n\t\t// padding: 0px 12px;\n\t\t&:hover{\n\t\t\tcolor: @color1;\n\t\t\tbackground: @bg3;\n\t\t}\n\t\t\n\t}\n\t.ed-menu-item{\n\t\tposition: relative;\n\t}\n\n\t&.ed-menu-alt{\n\t\t\n\t\t>.ed-menu-labels>.ed-menu-item-label{\n\t\t\tbackground-color: @bg2;\n\t\t}\n\t\t>.ed-menu-labels>.ed-menu-item-label.ed-selected{\n\t\t\tbackground-color: @bg1;\n\t\t}\n\t}\n}\n\n// .ed-menu-item-child{\n// \tposition: absolute;\n// \tleft: 0px;\n// \ttop: 0px;\n// }\n\n.ed-hidden{\n\tvisibility: hidden;\n}\n\n.ed-range-outer{\n\theight: @dim;\n    width: 100%;\n\tbackground: @bg2;\n\tposition: relative;\n\t.ed-range-slider{\n\t\twidth: 6.5px;\n\t\theight: @dim;\n\t\tbackground: @color1;\n\t\t&.ed-active{\n\t\t\tbackground: @color1;\n\t\t}\n\t\t\n\t}\n\t.ed-range-value{\n\t\tposition: absolute;\n\t\tleft: 14px;\n\t\ttop: 50%;\n\t\ttransform: translate(0%,-50%);\n\t\t&.ed-range-value-snap{\n\t\t\tright: 8px;\n\t\t\tleft: initial;\n\t\t}\n\t\t&.ed-range-value-left{\n\t\t\tright: 14px;\n\t\t\tleft: initial;\n\t\t\t&.ed-range-value-snap{\n\t\t\t\tleft: 8px;\n\t\t\t\tright: initial;\n\t\t\t}\n\t\t}\n\t\t\n\t}\n\tcursor: ew-resize;\n}\n\n.ed-button{\n\toutline: none;\n\t-webkit-appearance: none;\n\tfont: inherit;\n\tborder: none;\n\tcursor: pointer;\n\twidth: 100%;\n\theight: @dim;\n\tbackground: @bg2;\n\tcolor: @color2;\n\t&:hover{\n\t\tcolor: @color1;\n\t}\n}\n\n.ed-color-box{\n\tposition: relative;\n\t-webkit-appearance: none;\n\twidth: @dim * 2;\n\theight: @dim;\n\tflex-shrink: 0;\n\tcursor: pointer;\n\tmargin-right: @margin;\n\tborder: 3px solid black;\n\t.ed-color-box-input{\n\t\tvisibility: visible;\n\t\topacity: 0;\n\t\tcursor: pointer;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t\tposition: absolute;\n\t\tpadding: 0px;\n\t\tleft: 0px;\n\t\ttop: 0px;\n\t}\n}\n\n.ed-value-box{\n\twidth: 100%;\n\t// flex-shrink: 1;\n\theight: @dim;\n\tbackground-color: @bg1;\n\tmargin-left: @margin*.6;\n\tline-height: @dim;\n\tpadding: 0px @padding;\n}\n\n\n\n.ed-section{\n\t// margin: 0px;\n\tmargin: @padding 0px;\n\tpadding: @padding 0px;\n\tposition: relative;\n\t\n\t// text-transform: uppercase;\n\t// margin-bottom: 2px;\n\tborder-top: 1px solid @color4;\n\tborder-bottom: 1px solid @color4;\n\t// margin-bottom: 200px;\n\t// padding: @padding;\n}\n.ed-section-title{\n\tmin-height: @dim;\n\tcursor: pointer;\n\twhite-space: pre;\n\t\n\tfont-weight: 800;\n\twidth: 100%;\n\tpadding: 0px @padding;\n\ttext-transform: uppercase;\n}\n.ed-section-label-toggle-off{\n\tcursor: default;\n}\n.ed-section-label-toggle{\n\tfont-size: @fontsize;\n\twidth: 100%;\n\tpadding-right: @padding;\n\tdisplay: flex;\n\tcolor: @color3;\n\tflex-direction: column;\n\talign-items: flex-end;\n\tjustify-content: flex-end;\n\t&.ed-section-label-toggle-active{\n\t\tcolor: @color2;\n\t}\n}\n.ed-section-end-label{\n\tpadding: @padding;\n\tdisplay: flex;\n\twidth: 100%;\n\tflex-direction: row;\n\talign-items: center;\n\tjustify-content: center;\n\t// padding-left: @padding2;\n}\n\n.ed-input-select{\n\twidth: 100%;\n\toutline: none;\n\t-webkit-appearance: none;\n\theight: 24px;\n\tcursor: pointer;\n\tpadding: 0px @padding;\n\tborder: none;\n\tcolor: @color1;\n\tbackground: @bg2;\n}\n.ed-input-select-arrow{\n\tposition: absolute;\n\tright: 14px;\n\tcolor: @color3;\n\tfont-family: monospace;\n\n}\n\n.ed-separator{\n\tmargin-top: @dim / 3;\n\tborder-bottom: 1px solid @color4;\n\theight: 0px;\n\twidth: 100%;\n\tmargin-bottom: @dim / 2;\n}\n\n.ed-line-chart{\n\twidth: 100%;\n\theight: 80px;\n\tbackground: @bg2;\n}\n\n.ed-line-chart-wrap{\n\tflex-direction: column;\n\talign-content: flex-start;\n\tjustify-content: flex-start;\n\talign-items: flex-start;\n\tcanvas{\n\t\tcursor: ew-resize;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t}\n}\n.ed-line-chart-label{\n\t// width: 50%;\n\tpadding: @padding 0px;\n}\n\n.ed-anchor{\n\tdisplay: flex;\n\tflex-direction: row;\n\tposition: fixed;\n\t.ed-anchor-handle{\n\t\tposition: fixed;\n\t\tbackground: black;\n\t\tcursor: move;\n\t\tdisplay: flex;\n\t\tjustify-content: center;\n\t\talign-content: center;\n\t\talign-items: center;\n\t\t.ed-anchor-dot{\n\t\t\tmargin: (@dim/6);\n\t\t\tpointer-events: none;\n\t\t\tbackground: white;\n\t\t\twidth: (@dim/6);\n\t\t\theight: (@dim/6);\n\t\t}\n\t}\n\n\t.ed-anchor-content{\n\n\t}\n\n\t.ed-anchor-handle-resize{\n\t\twidth: (@dim/2);\n\t\theight: (@dim/2);\n\t\tbackground: black;\n\t\tposition: absolute;\n\t\t// cursor: ns-resize;\n\t\ttop:0;\n\t\tleft: 0;\n\t\tz-index: 1;\n\t}\n\n\t&.ed-anchor-drag{\n\t\tpointer-events: all;\n\t\tcursor: move;\n\t\t*{\n\t\t\tpointer-events: none !important;\n\t\t}\n\t}\n\t&.ed-anchor-resize{\n\t\tpointer-events: all;\n\t\t// cursor: ns-resize;\n\t\t*{\n\t\t\tpointer-events: none !important;\n\t\t}\n\t}\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ 	return __webpack_require__("./components/index.coffee");
/******/ })()
;
